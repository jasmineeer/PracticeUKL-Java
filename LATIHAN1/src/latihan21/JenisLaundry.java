 ...
 * @author Jasmi
 */
public final class JenisLaundry {
    private final ArrayList<String> namaJenisLaundry = new ArrayList<>();
    private final ArrayList<Integer> harga = new ArrayList<>();
    private final ArrayList<Integer> durasi = new ArrayList<>();
