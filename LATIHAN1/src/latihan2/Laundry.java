...
public class Laundry {
    ...
    public static void main(String[] args) {
        ...
        Listlaundry listlaundry = new Listlaundry();
        ...
        while (stay) {  /** selama nilai "stay" = true maka program terus berjalan */          
            ...
            if (menu == 1) {
                ...
                for (int i = 0; i < jumlahLaundry; i++) {
                    ...
                    Laundry selectedLaundry = listlaundry.list[foundLaundry];
                    
                    System.out.print("\nMAsukkan jumlah " + 
                            listlaundry.list[foundLaundry].getLaundry() +
                            " yang dicuci: ");
    ...
    Laundry(int i, String selimut, int i0, int i1) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    String getIdJenisLaundry() {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    String getJenisLaundry() {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
